...
namespace YourSpace.Areas.Identity.Pages.Account
{
    ...
    {
        public  IStringLocalizer<LoginPage> L;
        ...
        public LoginModel(SignInManager<MIdentityUser> signInManager, 
            ILogger<LoginModel> logger,
            UserManager<MIdentityUser> userManager, IStringLocalizer<LoginPage> l)
        {
        ...
        public class InputModel
        {
            ...
            [EmailAddress(ErrorMessageResourceName="EmailValid", ErrorMessageResourceType=typeof(ValidationMessages))]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, L["Invalid login"]);
                    return Page();
                }
            }
